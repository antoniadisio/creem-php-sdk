...
- `composer rector` applies the committed Rector rules for PHP 8.2-targeted refactors and safe code-quality cleanup. Type-declaration rules apply to internal code and tests, while the public facade/config/resource API is path-skipped for manual review.
